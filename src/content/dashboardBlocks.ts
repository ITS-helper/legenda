...
export const DASHBOARD_BLOCKS: DashboardBlockDefinition[] = [
  {
    ...
    description: 'Сводка за день, карточки бригад, топ-3, «Требуют внимания», «Бездействие в зоне проведения работ».',
    inReports: 'Ежедневная рассылка: сводные метрики, карточки бригад, список «Требуют внимания»',
  },
  {
    id: 'block2',
    number: 2,
    ...
    inReports: 'Еженедельная рассылка: сводные метрики, карточки бригад, список «Требуют внимания»',
  },
  {
    id: 'block3',
    number: 3,
