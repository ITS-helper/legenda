...
На дашборде в блоках «Ежедневная аналитика» и «Еженедельная аналитика» есть кнопка отправки:
вводится пароль админки, можно открыть предпросмотр или отправить активным получателям.
