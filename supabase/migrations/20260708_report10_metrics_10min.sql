-- Слабая активность и длительный простой: отчёт 11 + отчёт 10 (эпизоды ≥ 10 мин).
-- long_idle = sum(duration_min) * 60 из idle_episodes где duration_min >= 10
-- weak_activity = idle_sec (отчёт 11) − long_idle
