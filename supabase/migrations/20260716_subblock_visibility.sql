-- Видимость подблоков внутри блоков дашборда.

alter table analytics.metric_settings
  add column if not exists subblock_visibility jsonb not null default '{
    "block1_summary": true,
    "block1_brigades": true,
    "block1_top_activity": true,
    "block1_attention": true,
    "block1_kpp_panel": true,
    "block1_volume_card": true,
    "block2_brigades": true,
    "block2_top_activity": true,
    "block2_attention": true,
    "block3_activity_dynamics": true,
    "block3_volume_dynamics": true,
    "block4_location": true,
    "block4_idle": true
  }'::jsonb;
