-- AA_BLE: учитывать только минуты в окне рабочей смены 07:00–23:00 МСК.
...
drop view if exists analytics.kpp_minutes_daily;
...
create view analytics.kpp_minutes_daily as
select
  report_date,
  ww_shift_id,
  event_at
